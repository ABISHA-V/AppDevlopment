  ...
  return (
    <>
      ...
      <section className="px-10 py-8 bg-white min-h-screen mt-16">
        <span className="font-bold text-2xl text-black px-10 flex mt-3">
          Incomplete Tasks
        </span>
        {isTaskLoading ? (
          <p>Loading tasks...</p>
          ...
          <p className="text-black text-center mt-8 font-bold text-3xl">
          ...
          <div className="flex flex-wrap justify-center gap-5 mt-16">
            {filteredTasks.map((task) => (
              ...
              >
                <div className="bg-[#a5b1cf] shadow-md rounded-md p-4 text-white">
                  <h2 className="text-xl font-semibold mb-2">{task.title}</h2>
                  <p className="text-black mb-2">{task.des}</p>
                  <span
