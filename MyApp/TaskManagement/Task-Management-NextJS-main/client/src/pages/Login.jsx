      ...
      <div className="max-w-md w-full space-y-8 bg-white px-20 border py-5">
        ...
        <form className="mt-8 space-y-6" onSubmit={handleSubmit}>
          ...
          <div>
            <button
              type="submit"
              className="w-full py-2 px-4 border border-transparent rounded-md shadow-sm text-sm font-medium text-white bg-[#242f47] hover:bg-[#242f47] focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500"
